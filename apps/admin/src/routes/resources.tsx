    ...
    children: [
      {
        ...
        element: <ResourceList resourceName="LineItems" readOnly={true} />,
      },
      {
      ...
      },
      {
        ...
        element: <ResourceList resourceName="OrderApprovers" readOnly={true} />,
      },
      {
        path: "/orders/:direction/:orderID/approvals",
        element: <ResourceList resourceName="OrderApprovals" readOnly={true} />,
      },
      {
        path: `/orders/:direction/:orderID/payments`,
        element: <ResourceList resourceName="Payments" readOnly={true} />,
      },
      {
        path: `/orders/:direction/:orderID/shipments`,
        element: <ResourceList resourceName="OrderShipments" readOnly={true} />,
      },
    ],
  },
  {
    ...
    element: (
      <ResourceDetailWithParams resourceName="LineItems" readOnly={true} />
    ),
  },
  {
    path: "/orders/:direction/:orderID/payments/:paymentID",
    element: (
      <ResourceDetailWithParams resourceName="Payments" readOnly={true} />
    ),
  },
  {
    label: "Shipments",
    ...
    children: [
      {
        ...
        element: (
          <ResourceList resourceName="Categories" filters={{ depth: "all" }} />
        ),
      },
      {
        path: "/catalogs/:catalogID/buyers",
        element: (
          <ResourceAssignment fromResource="Buyers" toResource="Catalogs" />
        ),
      },
      {
